        ...
        if (files.length > 0) {
            try {
                for (MultipartFile file : files) {
                    ...
                    final String newFilePath = FileController2.generateNewFilePath();
                    final String newFileName = FileController2.generateNewFileName(originalFilename);
...
//                    pictureDO.setResourceId(resourceId);
        ...
        return result.success(ResultCodeEnum.SUCCESS, listPictures);
    }
