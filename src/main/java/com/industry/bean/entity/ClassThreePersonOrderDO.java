...
@ApiModel(value = "ClassThreePersonOrderDO对象", description = "三类人员订单表")
public class ClassThreePersonOrderDO implements Serializable {
    ...
    @TableField(exist = false)
    private ClassThreePersonDO classThreePerson;
}
