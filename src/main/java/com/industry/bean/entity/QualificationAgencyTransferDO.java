...
@TableName("t_qualification_agency_transfer")
@ApiModel(value = "QualificationAgencyTransferDO对象", description = "资质代办转账表")
public class QualificationAgencyTransferDO implements Serializable {
    ...
    @ApiModelProperty(value = "资质代办转账申请流水")
    @TableField(exist = false)
    private List<QualificationAgencyApprovalFlowDO> listTransferApproveFlows;
