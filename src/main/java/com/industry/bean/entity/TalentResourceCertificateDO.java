...
@TableName("t_talent_resource_certificate")
@ApiModel(value = "TalentResourceCertificateDO对象", description = "人才资源证书表")
public class TalentResourceCertificateDO implements Serializable {
    ...
    @ApiModelProperty(value = "人才资源主键id")
    @TableField("talent_resource_id")
    private Integer talentResourceId;
